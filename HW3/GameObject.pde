public class GameObject {
    ...
    void debugDraw() {
        ...
        for (int i = 0; i < mesh.triangles.size(); i++) {
            ...
            // use triangle's and viewDir's angle check front or back
            Vector3 v10 = img_pos[1].sub(img_pos[0]);
            Vector3 v20 = img_pos[2].sub(img_pos[0]);
            Vector3 normal = Vector3.cross(v10, v20).unit_vector();
